...
def test_jsdoc_extracted():
    funcs = extract.extract_from_file("tests/resources/with_jsdoc.js")
    assert len(funcs) == 1


def test_name_extracted_with_jsdoc():
    func = extract.extract_from_file("tests/resources/with_jsdoc.js")[0]
...
def test_nothing_extracted_from_empty_file():
    assert len(extract.extract_from_file("tests/resources/empty.js")) == 0


def test_no_return_type_extracted_from_no_jsdoc():
    func = extract.extract_from_file("tests/resources/without_jsdoc.js")[0]
